...
const AdminUserSchema = new Schema({
  ...
  role: { 
    type: String, 
    enum: ['super_admin', 'admin', 'compliance_officer', 'support_agent', 'analyst'], 
    required: true 
  },
...
const SystemSettingSchema = new Schema({
  ...
  category: { type: String, enum: ['general', 'security', 'payment', 'compliance', 'notification', 'feature'], required: true },
...
const OperationalTaskSchema = new Schema({
  ...
  taskType: { 
    type: String, 
    enum: ['kyc_review', 'loan_approval', 'transaction_review', 'fraud_investigation', 'customer_verification', 'other'], 
    required: true 
  },
...
const SupportTicketSchema = new Schema({
  ...
  category: { type: String, enum: ['account', 'transaction', 'card', 'loan', 'technical', 'billing', 'other'], required: true },
  priority: { type: String, enum: ['low', 'medium', 'high', 'urgent'], required: true },
...
const SupportMessageSchema = new Schema({
  ticket: { type: Schema.Types.ObjectId, ref: 'SupportTickets', required: true },
...
export const AdminPermissions = mongoose.model('AdminPermissions', AdminPermissionSchema);
export const AdminActionLogs = mongoose.model('AdminActionLogs', AdminActionLogSchema);
export const SystemSettings = mongoose.model('SystemSettings', SystemSettingSchema);
export const OperationalTasks = mongoose.model('OperationalTasks', OperationalTaskSchema);
export const SupportTickets = mongoose.model('SupportTickets', SupportTicketSchema);
export const SupportMessages = mongoose.model('SupportMessages', SupportMessageSchema);
