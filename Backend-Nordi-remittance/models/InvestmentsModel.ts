...
const SavingsGoalSchema = new Schema({
  ...
  category: { 
    type: String, 
    enum: ['emergency_fund', 'vacation', 'home', 'car', 'education', 'retirement', 'other'], 
    required: true 
  },
...
const InterestPlanSchema = new Schema({
  ...
  currency: { type: String, required: true, default: 'USD' },
  accountType: { type: String, enum: ['savings', 'fixed_deposit', 'investment'], required: true },
  term: { type: Number },
...
const PortfolioSchema = new Schema({
  user: { type: String, ref: 'Users', required: true },
  investmentAccount: { type: Schema.Types.ObjectId, ref: 'InvestmentAccounts', required: true },
...
const PortfolioTransactionSchema = new Schema({
  ...
  orderId: { type: String },
  orderType: { type: String, enum: ['market', 'limit', 'stop_loss', 'stop_limit'], required: true },
...
export const InterestPlans = mongoose.model('InterestPlans', InterestPlanSchema);
export const InvestmentAccounts = mongoose.model('InvestmentAccounts', InvestmentAccountSchema);
export const Assets = mongoose.model('Assets', AssetSchema);
export const Portfolios = mongoose.model('Portfolios', PortfolioSchema);
export const PortfolioTransactions = mongoose.model('PortfolioTransactions', PortfolioTransactionSchema);
