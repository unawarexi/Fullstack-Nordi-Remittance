 ...
 * @access  Private
 */
router.post("/update-email", rateLimit({ maxRequests: 3, windowMs: 60000 }), UsersController.updateEmail);
 ...
 * @access  Private
 */
router.post("/update-phone", rateLimit({ maxRequests: 3, windowMs: 60000 }), UsersController.updatePhone);
...
router.post(
  ...
  UsersController.markAllNotificationsRead,
);
...
router.post(
  "/delete-account",
  rateLimit({ maxRequests: 2, windowMs: 3600000 }),
 ...
 * @desc    Delete all users (admin only)
 * @access  Private/Admin
 */
router.delete("/", requireAdmin, UsersController.deleteAllUsers);
