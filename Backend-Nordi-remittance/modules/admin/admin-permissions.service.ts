...
export class AdminPermissionsService {
  ...
  static async setPermissionPreset(
    ...
    switch (preset) {
      case "full":
        permissionValues = {
          canViewUsers: true, canEditUsers: true, canSuspendUsers: true, canDeleteUsers: false,
          canVerifyKyc: true, canViewTransactions: true, canReverseTransactions: true, canRefundTransactions: true,
          canAdjustBalances: true, canManageLoans: true, canApproveLoans: true, canManageInvestments: true,
          canManageCards: true, canViewFraudCases: true, canManageFraudCases: true, canBlockAccounts: true,
          canAccessSecurityLogs: true, canManageSettings: false, canManageAdmins: false, canViewReports: true,
          canExportData: true, canManageTickets: true, canViewCustomerData: true,
        };
        break;
      case "limited":
        permissionValues = {
          canViewUsers: true, canEditUsers: false, canSuspendUsers: false, canDeleteUsers: false,
          canVerifyKyc: false, canViewTransactions: true, canReverseTransactions: false, canRefundTransactions: false,
          canAdjustBalances: false, canManageLoans: true, canApproveLoans: false, canManageInvestments: false,
          canManageCards: false, canViewFraudCases: true, canManageFraudCases: false, canBlockAccounts: false,
          canAccessSecurityLogs: false, canManageSettings: false, canManageAdmins: false, canViewReports: true,
          canExportData: false, canManageTickets: true, canViewCustomerData: true,
        };
        break;
      case "readonly":
        permissionValues = {
          canViewUsers: true, canEditUsers: false, canSuspendUsers: false, canDeleteUsers: false,
          canVerifyKyc: false, canViewTransactions: true, canReverseTransactions: false, canRefundTransactions: false,
          canAdjustBalances: false, canManageLoans: false, canApproveLoans: false, canManageInvestments: false,
          canManageCards: false, canViewFraudCases: true, canManageFraudCases: false, canBlockAccounts: false,
          canAccessSecurityLogs: false, canManageSettings: false, canManageAdmins: false, canViewReports: true,
          canExportData: false, canManageTickets: false, canViewCustomerData: true,
        };
        break;
      case "support":
        permissionValues = {
          canViewUsers: true, canEditUsers: false, canSuspendUsers: false, canDeleteUsers: false,
          canVerifyKyc: false, canViewTransactions: true, canReverseTransactions: false, canRefundTransactions: true,
          canAdjustBalances: false, canManageLoans: false, canApproveLoans: false, canManageInvestments: false,
          canManageCards: false, canViewFraudCases: false, canManageFraudCases: false, canBlockAccounts: false,
          canAccessSecurityLogs: false, canManageSettings: false, canManageAdmins: false, canViewReports: false,
          canExportData: false, canManageTickets: true, canViewCustomerData: true,
        };
        break;
      case "compliance":
        permissionValues = {
          canViewUsers: true, canEditUsers: false, canSuspendUsers: true, canDeleteUsers: false,
          canVerifyKyc: true, canViewTransactions: true, canReverseTransactions: false, canRefundTransactions: false,
          canAdjustBalances: false, canManageLoans: true, canApproveLoans: false, canManageInvestments: false,
          canManageCards: false, canViewFraudCases: true, canManageFraudCases: true, canBlockAccounts: true,
          canAccessSecurityLogs: true, canManageSettings: false, canManageAdmins: false, canViewReports: true,
          canExportData: true, canManageTickets: false, canViewCustomerData: true,
        };
        break;
      default:
    ...
    targetAdmin.permissions = permissions._id as any;
    targetAdmin.role =
      preset === "compliance" ? "compliance_officer" : preset === "support" ? "support_agent" : "admin";
    await targetAdmin.save();
   ...
   */
  static async revokeAllPermissions(currentUserId: string, targetAdminId: string, ip: string, userAgent: string) {
    const currentAdmin = await AdminUsers.findById(currentUserId);
    if (currentAdmin?.role !== "super_admin") {
    ...
    await AdminPermissions.findOneAndUpdate(
      ...
      {
        $set: {
          canViewUsers: false, canEditUsers: false, canSuspendUsers: false, canDeleteUsers: false,
          canVerifyKyc: false, canViewTransactions: false, canReverseTransactions: false, canRefundTransactions: false,
          canAdjustBalances: false, canManageLoans: false, canApproveLoans: false, canManageInvestments: false,
          canManageCards: false, canViewFraudCases: false, canManageFraudCases: false, canBlockAccounts: false,
          canAccessSecurityLogs: false, canManageSettings: false, canManageAdmins: false, canViewReports: false,
          canExportData: false, canManageTickets: false, canViewCustomerData: false,
          updatedAt: new Date(),
        },
      },
    );
