...
const BankIntegrationSchema = new Schema({
  ...
  integrationType: {
    type: String,
    enum: ["core_banking", "sponsor_bank", "partner_bank"],
    required: true,
  },
  status: {
    type: String,
  ...
  authMethod: {
    type: String,
    enum: ["api_key", "oauth2", "jwt", "basic_auth", "mutual_tls"],
    required: true,
  },
  credentials: {
    apiKey: { type: String },
...
const ThirdPartyAccountSchema = new Schema({
  ...
  provider: {
    type: String,
    enum: ["plaid", "yodlee", "finicity", "mx", "tink"],
    required: true,
  },
...
export const BankIntegrations = mongoose.model(
  "BankIntegrations",
  BankIntegrationSchema,
);
export const PaymentGateways = mongoose.model(
  "PaymentGateways",
  PaymentGatewaySchema,
);
export const WebhookSubscriptions = mongoose.model(
  "WebhookSubscriptions",
  WebhookSubscriptionSchema,
);
export const ThirdPartyAccounts = mongoose.model(
  "ThirdPartyAccounts",
  ThirdPartyAccountSchema,
);
