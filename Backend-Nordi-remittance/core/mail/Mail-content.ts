...
class EmailContentGenerator {
  ...
  constructor() {
    ...
    this.supportEmail =
      process.env.SUPPORT_EMAIL || "support@nordea-remittance.com";
  ...
  accountCreatedEmail(userData: UserAccountData): EmailTemplateData {
    return {
      ...
      QUICK_TIPS:
        "Enable two-factor authentication for enhanced security of your account.",
  ...
  transactionNotification(transactionData: TransactionData): EmailTemplateData {
    const isCredit =
      ...
      transactionData.type === "transfer_in";
      ...
      CONTENT_SECTIONS: [
        {
          title: "How to Redeem",
          content:
            promoData.redeemInstructions ||
            "Use the button below to claim your offer.",
        },
      ],
      BUTTONS: [
        {
  ...
  emailVerificationEmail(data: EmailVerificationData): EmailTemplateData {
    return {
      ...
      UNSUBSCRIBE_LINK: data.userId
        ? `${this.baseUrl}/unsubscribe?user=${data.userId}`
        : undefined,
    };
  }
  ...
  twoFactorEnabledEmail(data: TwoFactorEnabledData): EmailTemplateData {
    ...
    return {
      ...
      ALERT_BOX: {
        ...
        content:
          "Your account now has an extra layer of protection against unauthorized access.",
      },
      BUTTONS: [
        {
  ...
  loanDisbursedEmail(data: LoanDisbursedData): EmailTemplateData {
    return {
      ...
      ALERT_BOX: {
        ...
        content:
          "The loan amount is now available in your account and ready to use.",
      },
      BUTTONS: [
        {
  ...
  accountStatusUpdateEmail(data: AccountStatusData): EmailTemplateData {
    const statusConfig = {
      ...
      restricted: {
        ...
        alertType: "warning" as const,
        message:
          "Your account has been restricted. Some features may be unavailable.",
      },
    };
  ...
  accountRestoredEmail(data: AccountRestoredData): EmailTemplateData {
    return {
      ...
      ALERT_BOX: {
        ...
        content:
          "All restrictions have been lifted. Thank you for your patience and cooperation.",
      },
      BUTTONS: [
        {
  ...
  disputeClaimEmail(data: DisputeClaimData): EmailTemplateData {
    const statusConfig = {
      submitted: {
        ...
        alertType: "info" as const,
        message:
          "We have received your dispute claim and will begin reviewing it shortly.",
      },
      under_review: {
    ...
    return {
      ...
      ALERT_BOX: isCompleted
        ? {
            ...
            title: "🎉 Goal Achieved!",
            content:
              "You've successfully reached your savings target. Great job!",
          }
        : {
            type: "info",
            title: "Keep Going!",
