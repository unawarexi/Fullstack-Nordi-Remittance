...
class EmailContentGenerator {
  ...
  getBaseTemplateData(): BaseTemplateData {
    return {
      ...
      FOOTER_IMAGE:
        'https://fhdzjrj.stripocdn.email/content/guids/CABINET_d682b1c5c3e6ca19c2b709cadb8e0af619ba854080ca1e19025c86180c64ecd0/images/5.jpg',
    };
  }
  ...
  accountCreatedEmail(userData: UserAccountData): EmailTemplateData {
    return {
      ...
      HERO_IMAGE:
        'https://fhdzjrj.stripocdn.email/content/guids/CABINET_d682b1c5c3e6ca19c2b709cadb8e0af619ba854080ca1e19025c86180c64ecd0/images/6.jpg',
      MAIN_CONTENT: `
      ...
      UNSUBSCRIBE_LINK: userData.userId
        ? `${this.baseUrl}/unsubscribe?user=${userData.userId}`
        : undefined,
    };
  }
    ...
    return {
      ...
      BUTTONS:
        kycData.status === 'rejected'
          ...
          : undefined,
      UNSUBSCRIBE_LINK: kycData.userId
        ? `${this.baseUrl}/unsubscribe?user=${kycData.userId}`
        : undefined,
    };
  }
  ...
  transactionNotification(transactionData: TransactionData): EmailTemplateData {
    ...
    return {
      ...
      TRANSACTION_DETAILS: [
        ...
        {
          label: 'Amount',
          value: `${transactionData.currency} ${transactionData.amount}`,
        },
        { label: 'Reference', value: transactionData.referenceNumber },
        {
          label: 'Date',
          value: transactionData.createdAt || new Date().toLocaleString(),
        },
  ...
  cardIssuedEmail(cardData: CardIssuedData): EmailTemplateData {
    return {
      ...
      ALERT_BOX: {
        ...
        content:
          'Please activate your card before first use. You can activate it through the mobile app or web dashboard.',
      },
      BUTTONS: [
        {
          text: 'Activate Card',
      ...
      LOAN_DETAILS: {
        ...
        items: [
          { label: 'Loan Type', value: loanData.loanType },
          {
            ...
            value: `${loanData.currency} ${loanData.requestedAmount}`,
          },
  ...
  twoFactorDisabledEmail(data: TwoFactorDisabledData): EmailTemplateData {
    return {
      ...
      ALERT_BOX: {
        ...
        content:
          "If you didn't disable 2FA, your account may be compromised. Please change your password immediately and contact support.",
      },
      BUTTONS: [
        {
          text: 'Re-enable 2FA',
      ...
      LOAN_DETAILS: {
        ...
        items: [
          ...
          { label: 'First Payment Due', value: data.repaymentStartDate },
          {
            ...
            value: `${data.currency} ${data.monthlyPayment}`,
          },
        ],
      },
      ALERT_BOX: {
      ...
      ALERT_BOX:
        data.blockedBy !== 'user'
          ? {
              ...
              content:
                "If you didn't request this block, please contact our support team immediately.",
            }
          : {
              type: 'info',
              title: 'Card Secured',
              content:
                'Your card has been blocked as requested. You can unblock it anytime from your dashboard.',
            },
      BUTTONS: [
        {
          text: 'Manage Card',
  ...
  cardReportedEmail(data: CardReportedData): EmailTemplateData {
    ...
    return {
      ...
      ALERT_BOX: {
        ...
        title: 'Next Steps',
        content:
          'We recommend ordering a replacement card. Any pending transactions on this card will be reviewed.',
      },
      BUTTONS: [
        {
  ...
  adminAccountCreatedEmail(data: AdminAccountData): EmailTemplateData {
    return {
      ...
      ALERT_BOX: {
        ...
        title: 'Security Notice',
        content:
          'Please change your password immediately after your first login and enable two-factor authentication.',
      },
      BUTTONS: [
        {
      ...
      CONTENT_SECTIONS:
        data.resolution || data.notes
          ? [
              {
                title:
                  data.status === 'resolved' || data.status === 'rejected' ? 'Resolution' : 'Notes',
  ...
  loginAlertEmail(data: LoginAlertData): EmailTemplateData {
    return {
      ...
      ALERT_BOX: {
        ...
        title: "Wasn't you?",
        content:
          "If you don't recognize this login, please change your password immediately and enable two-factor authentication.",
      },
      BUTTONS: [
        {
          text: 'Review Activity',
  ...
  // Generated emails
  adminWalletCreditEmail(details: {
    firstName: string;
    currency: string;
    creditAmount: number;
    taxAmount: number;
    ...
    return {
      ...
      GREETING: `Hello ${details.firstName},`,
      MAIN_CONTENT: `
        <p>Your wallet has been credited.</p>
        <p><strong>Reference Number:</strong> ${details.referenceNumber}</p>
        <p><strong>Credit Amount:</strong> ${details.currency} ${details.creditAmount.toFixed(2)}</p>
        ${details.taxAmount > 0 ? `<p><strong>Original Amount:</strong> ${details.currency} ${details.originalAmount.toFixed(2)}</p><p><strong>Tax Deducted:</strong> ${details.currency} ${details.taxAmount.toFixed(2)}</p>` : ''}
        <p><strong>New Balance:</strong> ${details.currency} ${details.newBalance.toFixed(2)}</p>
      `,
    };
  }

  adminWalletDebitEmail(details: {
    firstName: string;
    currency: string;
    amount: number;
    referenceNumber: string;
    ...
    return {
      ...
      MAIN_CONTENT: `
        ...
        <p><strong>Reference Number:</strong> ${details.referenceNumber}</p>
        <p><strong>Debit Amount:</strong> ${details.currency} ${details.amount.toFixed(2)}</p>
  ...
  generateKycApprovedEmail(name: string): EmailTemplateData {
    return {
      ...this.getBaseTemplateData(),
      EMAIL_TITLE: 'KYC Approved',
      GREETING: `Hello ${name},`,
      MAIN_CONTENT: `
        <p>Good news! Your KYC documents have been reviewed and approved. Your account is now fully verified.</p>
      `,
    };
  }

  generateKycFailedEmail(name: string, reason: string): EmailTemplateData {
    return {
      ...this.getBaseTemplateData(),
      EMAIL_TITLE: 'KYC Update',
      GREETING: `Hello ${name},`,
      MAIN_CONTENT: `
        <p>Unfortunately, your recent KYC submission was not approved. Reason: ${reason}</p>
        <p>Please log in to your account and submit the required documents again.</p>
      `,
    };
  }
}
