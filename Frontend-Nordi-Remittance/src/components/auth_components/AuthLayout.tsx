    ...
    <section className="relative flex min-h-screen w-full overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className={cn("w-full", contentClassName || "max-w-md")}
        >
          {children}
        </motion.div>
        ...
        >
          <p>
            © 2024 Nordea Bank PLC. (Licensed by the International Monetary
            Fund)
          </p>
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute left-0 top-0 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white" />
