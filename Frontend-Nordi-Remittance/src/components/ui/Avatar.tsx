...
const sizeStyles: Record<AvatarSize, { container: string; text: string; icon: number; status: string }> = {
  xs: { container: 'w-6 h-6', text: 'text-[8px]', icon: 12, status: 'w-1.5 h-1.5 border' },
  ...
  lg: { container: 'w-12 h-12', text: 'text-base', icon: 20, status: 'w-3 h-3 border-2' },
  xl: { container: 'w-16 h-16', text: 'text-lg', icon: 24, status: 'w-3.5 h-3.5 border-2' },
  '2xl': { container: 'w-24 h-24', text: 'text-2xl', icon: 32, status: 'w-4 h-4 border-2' },
  '3xl': { container: 'w-32 h-32', text: 'text-3xl', icon: 48, status: 'w-5 h-5 border-2' },
};
...
export const AvatarGroup = forwardRef<HTMLDivElement, AvatarGroupProps>(
  ({ max, size = 'md', spacing = 'normal', children, className, ...props }, ref) => {
