...
export const identityVerificationSchema = z.object({
  ...
  idExpiryDate: z
    .date({ message: "ID expiry date is required" })
    .refine((date) => date > new Date(), { message: "ID must not be expired" }),
...
export const bankingPreferencesSchema = z
  .object({
...
export const securitySetupSchema = z
  .object({
...
export const signupInitialValues: Partial<SignupFormValues> = {
  gender: "",
  nationality: "",
  countryOfResidence: "",
  idType: "",
