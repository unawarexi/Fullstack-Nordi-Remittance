...
} from "../../domain/repository/transactions.repository";
...
export const useTransactions = (filters?: TransactionFilters) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await TransactionsRepository.getAll(filters);
      return response;
    },
  });
};
...
export const useTransaction = (transactionId: UUID) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await TransactionsRepository.getById(transactionId);
...
export const useTransactionByReference = (reference: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await TransactionsRepository.getByReference(reference);
      return response.data;
    },
    enabled: !!reference,
  });
...
export const useRecentTransactions = (limit?: number) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await TransactionsRepository.getRecent(limit);
      return response.data;
    },
  });
};
...
export const useDepositMethods = (currency?: Currency) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await TransactionsRepository.getDepositMethods(currency);
      return response.data;
    },
  });
};
...
export const useRemittanceCountries = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await TransactionsRepository.getRemittanceCountries();
      return response.data;
    },
...
export const useTransfer = () => {
  ...
  return useMutation({
    mutationFn: async (data: TransferRequest) => {
      const response = await TransactionsRepository.transfer(data);
      return response.data;
    },
    onSuccess: () => {
...
export const useTransferToUser = () => {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const response = await TransactionsRepository.transferToUser(data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.accounts.all });
...
export const useScheduleTransfer = () => {
  ...
  return useMutation({
    mutationFn: async (
      ...
      const response = await TransactionsRepository.scheduleTransfer(data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.transactions.all });
...
export const useCancelScheduledTransfer = () => {
  ...
  return useMutation({
    mutationFn: async (scheduleId: UUID) => {
      const response =
        await TransactionsRepository.cancelScheduledTransfer(scheduleId);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.transactions.all });
...
export const useSendRemittance = () => {
  ...
  return useMutation({
    mutationFn: async (data: RemittanceRequest) => {
      const response = await TransactionsRepository.sendRemittance(data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.accounts.all });
...
export const useRemittanceQuote = () => {
  return useMutation({
    mutationFn: async (data: {
      ...
      const response = await TransactionsRepository.getRemittanceQuote(data);
      return response.data;
    },
  });
};
...
export const useDeposit = () => {
  ...
  return useMutation({
    mutationFn: async (data: DepositRequest) => {
      const response = await TransactionsRepository.deposit(data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.accounts.all });
...
export const useWithdraw = () => {
  ...
  return useMutation({
    mutationFn: async (data: WithdrawalRequest) => {
      const response = await TransactionsRepository.withdraw(data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.accounts.all });
...
export const useCalculateFee = () => {
  return useMutation({
    mutationFn: async (data: {
      ...
      const response = await TransactionsRepository.calculateFee(data);
      return response.data;
    },
  });
};
...
export const useGetReceipt = () => {
  ...
  return useMutation({
    mutationFn: async (transactionId: UUID) => {
      const response = await TransactionsRepository.getReceipt(transactionId);
      return response.data;
    },
    onError: (error: Error) => {
...
export const useEmailReceipt = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await TransactionsRepository.emailReceipt(transactionId, email);
      return response.data;
    },
    onSuccess: () => {
...
export const useRecipients = (params?: {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await RecipientsRepository.getAll(params);
      return response;
    },
  });
};
...
export const useRecipient = (recipientId: UUID) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await RecipientsRepository.getById(recipientId);
      return response.data;
    },
    enabled: !!recipientId,
  });
...
export const useFavoriteRecipients = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await RecipientsRepository.getFavorites();
      return response.data;
    },
  });
};
...
export const useRecentRecipients = (limit?: number) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await RecipientsRepository.getRecent(limit);
      return response.data;
    },
  });
};
...
export const useCreateRecipient = () => {
  ...
  return useMutation({
    mutationFn: async (data: CreateRecipientRequest) => {
      const response = await RecipientsRepository.create(data);
      return response.data;
    },
    onSuccess: () => {
...
export const useUpdateRecipient = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await RecipientsRepository.update(recipientId, data);
      return response.data;
    },
    onSuccess: (data) => {
...
export const useDeleteRecipient = () => {
  ...
  return useMutation({
    mutationFn: async (recipientId: UUID) => {
      const response = await RecipientsRepository.delete(recipientId);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.recipients.all });
...
export const useToggleRecipientFavorite = () => {
  ...
  return useMutation({
    mutationFn: async (recipientId: UUID) => {
      const response = await RecipientsRepository.toggleFavorite(recipientId);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.recipients.all });
