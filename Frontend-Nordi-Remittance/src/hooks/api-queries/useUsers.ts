...
export const useUserProfile = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await UsersRepository.getProfile();
...
export const useUserAddress = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await UsersRepository.getAddress();
      return response.data;
    },
  });
};
...
export const useUserEmployment = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await UsersRepository.getEmployment();
      return response.data;
    },
  });
};
...
export const useUserBankAccounts = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await UsersRepository.getBankAccounts();
      return response.data;
    },
  });
};
...
export const useUserNotificationPreferences = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await UsersRepository.getNotificationPreferences();
      return response.data;
    },
  });
};
...
export const useUserReferralStats = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await UsersRepository.getReferralStats();
      return response.data;
    },
  });
};
...
export const useReferredUsers = (params?: {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await UsersRepository.getReferredUsers(params);
      return response;
    },
  });
};
...
export const useUpdateProfile = () => {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const response = await UsersRepository.updateProfile(data);
      return response.data;
    },
    onSuccess: () => {
...
export const useUpdateAvatar = () => {
  ...
  return useMutation({
    mutationFn: async (file: File) => {
      const response = await UsersRepository.updateAvatar(file);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.users.profile() });
...
export const useDeleteAvatar = () => {
  ...
  return useMutation({
    mutationFn: async () => {
      const response = await UsersRepository.deleteAvatar();
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.users.profile() });
...
export const useUpdateAddress = () => {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const response = await UsersRepository.updateAddress(data);
      return response.data;
    },
    onSuccess: () => {
...
export const useUpdateEmployment = () => {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const response = await UsersRepository.updateEmployment(data);
      return response.data;
    },
    onSuccess: () => {
...
export const useAddBankAccount = () => {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const response = await UsersRepository.addBankAccount(data);
      return response.data;
    },
    onSuccess: () => {
...
export const useUpdateBankAccount = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await UsersRepository.updateBankAccount(accountId, data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({
...
export const useDeleteBankAccount = () => {
  ...
  return useMutation({
    mutationFn: async (accountId: UUID) => {
      const response = await UsersRepository.deleteBankAccount(accountId);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({
...
export const useSetPrimaryBankAccount = () => {
  ...
  return useMutation({
    mutationFn: async (accountId: UUID) => {
      const response = await UsersRepository.setPrimaryBankAccount(accountId);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({
...
export const useVerifyBankAccount = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await UsersRepository.verifyBankAccount(accountId, amounts);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({
...
export const useUpdateUserNotificationPreferences = () => {
  ...
  return useMutation({
    mutationFn: async (data: Partial<NotificationPreferences>) => {
      const response = await UsersRepository.updateNotificationPreferences(data);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({
...
export const useDeleteUserAccount = () => {
  ...
  return useMutation({
    mutationFn: async (password: string) => {
      const response = await UsersRepository.deleteAccount(password);
      return response.data;
    },
    onSuccess: () => {
...
export const useExportUserData = () => {
  ...
  return useMutation({
    mutationFn: async () => {
      const response = await UsersRepository.exportData();
      return response.data;
    },
    onSuccess: () => {
      showToast(
