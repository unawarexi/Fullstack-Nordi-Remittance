...
import { FraudRepository } from '../../domain/repository/fraud.repository';
...
export const useBehaviorProfile = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getBehaviorProfile();
...
export const useAdminBehaviorProfile = (userId: UUID) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getAdminBehaviorProfile(userId);
      return response.data;
    },
    enabled: !!userId,
  });
...
export const useFraudSignals = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getSignals();
      return response.data || [];
    },
  });
};
...
export const useFraudSignal = (signalId: UUID) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getSignalById(signalId);
      return response.data;
    },
    enabled: !!signalId,
  });
...
export const useUpdateFraudSignal = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await FraudRepository.updateSignal(signalId, data);
      return response.data;
    },
...
export const useFraudCases = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getCases();
      return response.data || [];
    },
  });
};
...
export const useFraudCase = (caseId: UUID) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getCaseById(caseId);
      return response.data;
    },
    enabled: !!caseId,
  });
...
export const useCreateFraudCase = () => {
  ...
  return useMutation({
    mutationFn: async (data: Partial<FraudCase>) => {
      const response = await FraudRepository.createCase(data);
      return response.data;
    },
    onSuccess: () => {
...
export const useUpdateFraudCase = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await FraudRepository.updateCase(caseId, data);
      return response.data;
    },
    onSuccess: (_, { caseId }) => {
      queryClient.invalidateQueries({ queryKey: ["fraud", "cases"] });
...
export const useVelocityRules = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getVelocityRules();
      return response.data || [];
    },
  });
};
...
export const useSecurityEvents = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getSecurityEvents();
      return response.data || [];
    },
  });
};
...
export const useFraudAnalytics = () => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await FraudRepository.getAnalytics();
      return response.data;
    },
  });
};
