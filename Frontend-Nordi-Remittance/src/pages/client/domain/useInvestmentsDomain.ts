...
export function useClientInvestments(filters?: { type?: InvestmentType; status?: InvestmentStatus; page?: number; limit?: number }) {
...
export function useClientInvestmentProducts(filters?: { type?: InvestmentType; minInvestment?: number; riskLevel?: "low" | "medium" | "high" }) {
