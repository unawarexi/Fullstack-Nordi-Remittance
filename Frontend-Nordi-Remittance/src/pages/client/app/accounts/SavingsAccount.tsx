      ...
      {isLoading ? (
        ...
        <StatsGrid cols={3}>
          ...
          <StatCard
            ...
            value={show ? fmt(wallets.reduce((a: number, w: any) => a + (w.interestEarned || 0), 0)) : "••••••"}
      ...
      {wallets.length === 0 && !isLoading ? (
        ...
        <DashCard padding="none" className="mt-6">
          <div className="border-b border-gray-200 p-4 dark:border-gray-800">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white sm:text-base">Savings Accounts</h3>
          </div>
