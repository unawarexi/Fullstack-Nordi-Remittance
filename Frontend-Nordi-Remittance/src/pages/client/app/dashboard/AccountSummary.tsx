...
import { ACCOUNT_TYPE_MAP } from "../../domain/constants/dashboard.constants";
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className={`p-1.5 rounded-lg ${typeInfo.color}`}>{typeInfo.icon}</div>
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-white text-xs sm:text-sm">{wallet.name}</h4>
