...
const TierCard: React.FC<TierCardProps> = ({ tier, index }) => (
  ...
  >
    <div className="flex items-center gap-3 mb-4">
      ...
      <div>
        <h4 className="font-semibold text-neutral-900">{tier.name}</h4>
        <p className="text-xs text-neutral-500">{tier.requirement}</p>
      </div>
    </div>
      ...
      <Container size="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          >
            ...
            {/* Stats */}
            <div className="mt-8 flex items-center gap-6 p-4 rounded-xl bg-white border border-neutral-100">
              <div>
                <div className="text-2xl font-bold text-indigo-600">$125M+</div>
                <div className="text-xs text-neutral-500">Cashback paid</div>
              </div>
