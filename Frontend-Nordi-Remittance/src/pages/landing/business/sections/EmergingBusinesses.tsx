...
const ProgramCard: React.FC<ProgramCardProps> = ({ program, index }) => (
  ...
  >
    ...
    {/* Header */}
    <h3 className="text-xl font-semibold text-neutral-900 mb-1">{program.name}</h3>
            ...
            {successStories.map((story, index) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-semibold text-neutral-900">{story.company}</p>
                    <p className="text-sm text-neutral-500">Founded by {story.founder}</p>
                  </div>
                </div>
                <p className="text-sm text-neutral-600 italic mb-4">"{story.quote}"</p>
                <div className="flex gap-4 pt-4 border-t border-neutral-100">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-neutral-900">{story.employees}</p>
                  </div>
                </div>
              </motion.div>
            ))}
