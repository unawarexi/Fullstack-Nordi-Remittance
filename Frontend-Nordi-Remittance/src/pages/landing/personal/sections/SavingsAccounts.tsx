  ...
  >
    ...
    {account.popular && (
      <div className="absolute -top-3 left-1/2 -translate-x-1/2">
        <span className="inline-flex items-center gap-1 px-3 py-1 bg-indigo-500 text-white text-xs font-medium rounded-full">
    ...
    <div className="py-4 border-y border-neutral-100 mb-4">
      <div className="flex items-baseline gap-1">
        <span className="text-4xl font-bold text-neutral-900">{account.interestRate}</span>
