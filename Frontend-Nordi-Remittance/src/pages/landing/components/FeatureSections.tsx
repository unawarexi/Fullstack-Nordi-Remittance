        ...
        <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            <Card variant="glass" className="bg-white/10 border-white/20">
              <CardContent className="p-6 sm:p-8">
                ...
                <p className="text-white/80 text-sm sm:text-base lg:text-lg mb-6 max-w-lg">
          ...
          >
            <img
              ...
              className="max-w-[280px] sm:max-w-xs md:max-w-sm lg:max-w-md drop-shadow-2xl"
            />
          </motion.div>
        </div>
      </Container>
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {icon && (
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-slate-200 flex items-center justify-center mb-4">
            {typeof icon === 'string' ? (
        ...
        >
          ...
          <div className="flex flex-col xl:flex-row gap-6">
            <FeatureCard
              ...
              image={AppFrame}
              className="xl:flex-[2] bg-slate-100"
            />
            ...
            <FeatureCard
              ...
              className="xl:flex-1 bg-slate-200"
            />
          </div>
