...
import { useFailedTransactionManagement } from "../../domain/useTransactionManagement";
...
export default function FailedTransactions() {
  ...
  return (
    <PageContainer>
      ...
      <StatsGrid>
        <StatCard label="Failed Transactions" value={total} icon={<XCircle size={18} />} iconColor="from-rose-500 to-rose-600" change="" positive={false} index={0} />
      </StatsGrid>
                ...
                <AnimatePresence mode="popLayout">
                  {transactions.map((tx: any, i: number) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <p className="text-xs text-rose-600 dark:text-rose-400 max-w-[200px] truncate">
