...
import {
  ...
  useRemittanceStats,
  useRemittanceByCountry,
} from "@hooks/queries";
import { useFraudAnalytics } from "@hooks/queries";
...
function periodToParam(period: TimePeriod) {
  switch (period) {
    case "7d": return "1W" as const;
    case "30d": return "1M" as const;
    case "90d": return "3M" as const;
    case "1y": return "1Y" as const;
  }
}
